...
# show accuracy
def printDestree(cri = 'gini', split = 'best', mDep = None):  
    myGini = DecisionTreeClassifier(criterion=cri, splitter=split, max_depth= mDep)
...
#gini
printDestree('gini', 'best', 3)
printDestree('entropy', 'best',3)
printDestree('log_loss', 'best',3)
